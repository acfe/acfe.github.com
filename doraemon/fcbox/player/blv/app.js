  ...
  methods: {
    ...
    touchmove (e) {
      ...
      if (scrollParam.move) {
        ...
        let br = parseInt(Math.abs(changeY / 8)) - 3
        br = br < 1 ? 1 : br
        br = br > 50 ? 50 : br
        this.renderFlip.className = 'blv-player-scroll blv' + br
        let clientWidth = this.renderFlip.clientWidth
        let scale = Math.abs(changeY / 10) / clientWidth
    ...
    play (added, callback) {
      ...
      this.animating = true
      let tEnd = 48
      let br = parseInt(Math.abs(this.changeY / 8)) - 3
      br = br < 1 ? 1 : br
      br = br > 50 ? 50 : br
      let clientWidth = this.renderFlip.clientWidth
      let scale = 1 - Math.abs(this.changeY / 10) / clientWidth
        ...
        handle (num, acNum) {
          switch (added) {
            case 0:
              ...
              that.renderFlip.className = 'blv-player-scroll blv' + parseInt(rBArr[acNum])
              break
            case 1:
              Object.assign(that.renderFlip.style, {
                opacity: opArr[acNum]
              })
              that.nextFlip.className = 'blv-player-scroll blv' + parseInt(sBArr[acNum])
            ...
            case -1:
              ...
              that.preFlip.className = 'blv-player-scroll blv' + parseInt(sBArr[acNum])
