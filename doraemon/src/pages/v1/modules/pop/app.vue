<template>
    <div class="m-pop" :class="{'m-absolute': isSet}" v-if="(isSet && popId == setConfig.setPopId) || param.show" ref="fcPop">
      ...
      <div v-for="(item, key) in param.elements" :key="key">
        ...
        <ESearch v-if="item.tag == 'search'" :param="item" :eid="key" mid="pop" :isSet="isSet" :setConfig="setConfig" :zIndex="param.elements.length - key" :acCallback="acCallback"/>
      </div>
    </div>
    </div>  
</template>
