...
Index.prototype = {
  ...
  pageInit: function () {
    ...
    app.innerHTML = '<div class="loadingImg"><img src="/dora/img/loading.gif"></div>'
    this.createCss(show)
    setTimeout(function () {
  ...
  createCss: function (name) {
    ...
    link.href = publicPath + 'css/' + name + '.css?0.8208818132520828'
  },
  ...
  createJs: function (name, callback) {
    ...
    script.async = false
    script.src = publicPath + 'js/' + name + '.js?0.8208818132520828'
