...
Index.prototype = {
  ...
  pageInit: function () {
    ...
    app.innerHTML = '<div class="loadingImg"><img src="/img/loading.gif"></div>'
    this.createCss(show)
    setTimeout(function () {
  ...
  createCss: function (name) {
    ...
    link.href = publicPath + 'css/' + name + '.css?0.09890970177359737'
  },
  ...
  createJs: function (name, callback) {
    ...
    script.async = false
    script.src = publicPath + 'js/' + name + '.js?0.09890970177359737'
